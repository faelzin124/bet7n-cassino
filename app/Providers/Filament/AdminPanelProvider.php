                    ...
                    NavigationGroup::make('DEFINIÇÕES DA PLATAFORMA')
                        ->items([
                            ...
                            NavigationItem::make('custom-layout')
                                ...
                                ->label(fn (): string => 'DEFINIÇÕES DE CORES E POPUP')
                                ->url(fn (): string => LayoutCssCustom::getUrl())
                                ->isActiveWhen(fn () => request()->routeIs('filament.admin.resources.layout-css-custom.*'))
                                ->visible(fn(): bool => auth()->user()->hasRole('admin')),
                            NavigationItem::make('wizzepro')
                                ->icon('heroicon-o-cpu-chip')
                                ->label(fn (): string => 'WIZZE PRO API WHATSAPP E SMS')
                                ->url(fn (): string => Settings::getUrl())
                                ->isActiveWhen(fn () => request()->routeIs('filament.admin.resources.wizzepro.*'))
                                ->visible(fn(): bool => auth()->user()->hasRole('admin')),
                            ...
                            NavigationItem::make('games-key')
                                ->icon('heroicon-o-cpu-chip')
                                ->label(fn (): string => 'CHAVES DE API DOS JOGOS')
