<!doctype html>
<html lang="zn-CN" data-data="网站主体" data-version="<?php echo e(now()->toString()); ?>" class="网站主体" data-city="São Paulo/Brazil" data-developer="scriptdecassino.com">
    <head>
        <meta charset="UTF-8">
    ...
    <body id="海永系统" color-theme="dark" class="bg-base text-gray-800 dark:text-gray-300 ">
        <div id="顶部"></div>
        <div id="hayon" class="网站主体"></div>
        ...
        <script>
            ...
            console.log('scriptdecassino.com');
            localStorage.setItem('developer', 'scriptdecassino.com');
        </script>
...
<?php /**PATH /www/wwwroot/demo01.whitehayon.site/resources/views/layouts/app.blade.php ENDPATH**/ ?>